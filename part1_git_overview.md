...
### merge 
`git merge <name>` - will merge branch *name* in current branch. 
### delete 
...
### update from remote
* `git fetch` - asks remote to provide actual information that have been made in remote origin since last sync. do not affects your local files - just gets history
* `git pull` - updates your local copy from remote
### update remote
